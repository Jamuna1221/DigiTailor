        ...
        {cartItems.length > 0 && (
          <div className="border-t border-gray-200 p-6 space-y-4">
            ...
            <button
              ...
              className="w-full py-4 rounded-xl font-semibold text-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:from-blue-700 hover:to-purple-700 transition-all duration-300"
            >
