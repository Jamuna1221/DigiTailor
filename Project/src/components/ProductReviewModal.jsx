...
function ProductReviewModal({ 
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (data.success) {
        toast.success(`✅ Review submitted successfully${images.length > 0 ? ` with ${images.length} image${images.length > 1 ? 's' : ''}!` : '!'}`)
        onSubmit(product.productId)
      } else {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-2xl font-bold text-gray-900">📝 Review Product</h3>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Tell us about the quality, fit, and your experience with this product..."
              maxLength="1000"
            />
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>• Share photos showing quality and details</li>
                  <li>• Mention fit, comfort, and durability</li>
                  <li>• Include delivery experience if relevant</li>
